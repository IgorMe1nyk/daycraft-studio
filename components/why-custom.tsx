...
/* ─────────────────────────────────────────────────────────────────────────
   WhyCustom — an honest, interactive answer to "why not a $30/mo builder?"

   Shared by the homepage (between Services and Work) and /why-custom.
   Tone: fair to builders, calm, understated. Every number is true + sourced
   (see the sources line at the bottom). No "free forever", no hype.
   ───────────────────────────────────────────────────────────────────── */

const easeOut = [0.22, 1, 0.36, 1] as const;

// Chart is lazy-loaded so Recharts stays out of the initial bundle.
...
/* Gentle count-up that runs when scrolled into view and on value changes.
...
export function WhyCustom({
  ...
  /** "h1" on the standalone /why-custom page; "h2" as a homepage section. */
  headingTag?: "h1" | "h2";
}) {
  ...
  return (
    <section
      id="why-custom"
      className="py-24 lg:py-32 scroll-mt-24"
      ...
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="mt-5 text-warmGray text-body-lg leading-relaxed">
            ...
            own — and the math is on your side.
          </p>
        </div>
        ...
        <div className="mt-10 flex flex-col items-center gap-6">
          ...
          <div className="w-full max-w-md">
            ...
            >
              <span>
                Over{" "}
                <span className="font-medium tabular-nums">{years}</span>{" "}
                {years === 1 ? "year" : "years"}
              </span>
