...
/**
 * Brand-mark SVG icons that lucide-react doesn't ship in its default set.
 * They accept the same prop shape as lucide icons so they can be slotted in
 * anywhere a lucide icon is expected.
 */

export function WhatsAppIcon({ className, ...props }: LucideProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
